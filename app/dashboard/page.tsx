 ...
 *
 * The three cards below are placeholders (see lib/insights/placeholder.ts):
 * this screen is the boilerplate to build the real recommendation mechanism
 * against, not that mechanism itself.
 */
